...
twitter.lines.sample = twitter.lines[
    sample(
        ...
        round(length(twitter.lines) * 0.1)
    )
]
rm(twitter.lines)
...
Now I have sample data set that contains `r length(sample.lines)` lines of representative data. We can easly process it but in the other hand we can make some suggestions on the basis of that data. 

### Clean Up Sample Data Set

On this step I will create new Corpus of the **tm** package and remove from text stop words, numbers and punctuation. I also would like to remove profanity words from all texts to prevent my work from being confusing.
